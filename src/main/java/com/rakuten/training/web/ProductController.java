...
public class ProductController {
	...
	//here below code we cannot manually send response based on id coz for value with i
	//d not present in db it will give empty page not error
...
//	}
	...
	//here we added ResponseEntity geniric so we can manipulate the result explicitly
	@GetMapping("/products/{id}")
